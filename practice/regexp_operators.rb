...
Log.cyan "Word character (digit, letter or underscore):"
Log.put "'Robin_Buko27 Smith'.match(/\\w*/)"
puts

Log.cyan "Non-word character:"
Log.put "'  ,/.Robin_Buko27 Smith'.match(/\\W*/)"
puts

Log.cyan "Whitespace character:"
Log.put "'Robin_Buko27 Smith'.match(/\\s.*/)"
puts

Log.cyan "Non-whitespace character:"
Log.put "'Robin_Buko27 Smith'.match(/\\S*/)"
puts

Log.cyan "Digit (same as [0-9]):"
...
Log.cyan "Hexadecimal digit (same as [0-9a-f]):"
Log.put "'Robin_Buko 1b Smith'.match(/\\h/)"
puts

Log.cyan "Non-hexadecimal digit:"
Log.put "'Robin_Buko1b Smith'.match(/\\H\\H/)"
puts

Log.cyan "Beginning of string:"
Log.put "'Robin Smith'.match(/\\ARobin.*/)"
puts

Log.cyan "End of string or before newline at the end:"
Log.put "'Robin Smith Smith\n'.match(/Smith\\Z.*/)"
puts

Log.cyan "End of string:"
Log.put "'Robin Smith Smith'.match(/Smith\\z.*/)"
puts

Log.cyan "Word boundary (used outside [] only):"
Log.put "'Robin SmithSmith'.match(/h\\b.*/)"
puts

Log.cyan "Non-word boundary:"
Log.put "'Robin SmithSmith'.match(/h\\B.*/)"
puts

Log.cyan "Backspace (inside [] only):"
...
Log.cyan "m to n instances of previous sub-expression:"
Log.put "'Robinnnnnnnn'.scan(/n{0,3}/)"
Log.put "'Robinnnnnnnn'.scan(/n{1,3}/)"
puts

Log.cyan "m to n instances of previous sub-expression (non-greedy):"
Log.put "'Robinnnnnnnn'.scan(/n{1,3}?/)"
puts
